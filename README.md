...
| 26.09.03 | AWS CI/CD 진행 docker-compose | AWS CI/CD  docker-compose 설치 까지 | [보러가기](./doc/2026-09-03.md ) |
| 26.09.04 | PostgresSQL DB 설치 및 사용 | PostgresSQL DB 설치 및 vector DB 세팅하고 직접 사용해보기(Spring AI REG 사용위한 세팅) | [보러가기](./doc/2026-09-04.md ) |
| 26.09.07 | Spring AI vector | SpringAI vector 이용 숫자 근사치 추천 검색 AI | [보러가기](./doc/2026-09-07.md ) |
| 26.09.08 | Jenkins로 추천 레시피 검색 AI 배포 관리 | Jenkins 구동해서 추천 레시피 검색 AI 배포 자동화 관리 | [보러가기](./doc/2026-09-08.md ) |
| 26.09.09 | Spring AI RAG | RAG 이용해 레시피 추천 AI 모델 제작 실습 진행 | [보러가기](./doc/2026-09-09.md ) |
| 26.09.10 | Spring AI RAG | vector를 이용한 RAG 추천 검색 AI | [보러가기](./doc/2026-09-10.md ) |
| 26.09.11 | 프로젝트 진행 | 프로젝트 도서 상세페이지 도서 리뷰 CRUD 진행 | [보러가기](./doc/finalproject.md ) |
| 26.09.14 | 프로젝트 진행 | 프로젝트 도서 리뷰 CRUD 구현 및 프로젝트 전반의 코드 수정 | [보러가기](./doc/finalproject.md ) |
| 26.09.15 | 프로젝트 진행 | 프로젝트 페이지 별 접근 제어 및 에러페이지 생성 | [보러가기](./doc/finalproject.md ) |
| 26.09.16 | React 학습  | React를 기존에 사용하던 vue와 비교하며 학습 | [보러가기](./doc/2026-09-16.md ) |
| 26.09.17 | TypeScript 학습 | TypeScript - 타입 안정성과 React 연동 | [보러가기](./doc/2026-09-17.md ) |
| 26.09.18 | TanStack Query | TanStack Query - 서버 상태 관리 | [보러가기](./doc/2026-09-18.md ) |
| 26.09.21 | 프로젝트 CICD 무중단 배포 | 프로젝트 CICD 무중단 배포 및 발표 진행 | [보러가기](./doc/finalproject.md ) |
| 26.07.20 ~ 26.09.23 |  학습자료 정리 | 웹 학습에 도움이 되는 자료 모음 | [보러가기](./Spring_정리자료) |
